...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 bpf uretprobe.c -- -I../../lib/common -I../../lib/libbpf/src
...
func BashReadline() {
	...
	for {
		...
		log.Printf("PID: %d, %s:%s return value: %s", event.Pid, binPath, symbol, unix.ByteSliceToString(event.Line[:]))
	}
}
